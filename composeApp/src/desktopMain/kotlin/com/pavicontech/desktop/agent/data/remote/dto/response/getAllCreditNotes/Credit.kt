...
data class Credit(
    ...
    @SerialName("curRcptNo") val curRcptNo: String,
    ...
    @SerialName("intrlData") val intrlData: String,
    ...
    @SerialName("rcptSign") val rcptSign: String,
    ...
    @SerialName("totRcptNo") val totRcptNo: String,
